...
exports.handler = async (event) => {
  ...
  const groupParams = {
    GroupName: (event.request.userAttributes['custom:provider'] === '1') ? 'provider' : process.env.GROUP,
    UserPoolId: event.userPoolId,
  };

  console.log("add-to-groups.event: ", event)
  ...
  console.log("add-to-group.addUserParams: ", addUserParams)
